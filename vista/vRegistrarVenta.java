...
public class vRegistrarVenta extends JInternalFrame {
	...
	public vRegistrarVenta() {
		...
		txtCBO.setBounds(328, 101, 86, 20);
		panel.add(txtCBO);
		
		lblIMG = new JLabel("");
		lblIMG.setIcon(new ImageIcon(vRegistrarVenta.class.getResource("/img/logo100p.jpg")));
		lblIMG.setBounds(42, 11, 109, 125);
		panel.add(lblIMG);
		
		JPanel panel_2 = new JPanel();
		panel_2.setLayout(null);
		panel_2.setBackground(Color.WHITE);
		panel_2.setBounds(10, 359, 682, 170);
		getContentPane().add(panel_2);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 11, 662, 148);
		...
		panel_1.setBounds(10, 171, 682, 152);
		...
		btnBuscarC.setBounds(259, 39, 130, 27);
		...
		btnBuscarP.setBounds(259, 76, 130, 27);
		...
		txtVendedor.setBounds(223, 11, 166, 20);
		...
		txtIdV.setBounds(105, 11, 108, 20);
		panel_1.add(txtIdV);
		txtIdV.setColumns(10);
		
		lblNewLabel = new JLabel("FECHA ");
		lblNewLabel.setFont(new Font("Verdana", Font.BOLD, 12));
		lblNewLabel.setBounds(412, 13, 260, 14);
		panel_1.add(lblNewLabel);
		
		btnAgregar = new JButton("Agregar");
		btnAgregar.setBounds(259, 111, 130, 27);
		...
		btnCerrar.setBounds(335, 540, 116, 27);
		...
		btnGenerarVenta.setBounds(10, 540, 166, 27);
		...
		btnImprimir.setBounds(186, 540, 139, 27);
