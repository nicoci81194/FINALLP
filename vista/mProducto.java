...
public class mProducto extends JInternalFrame {
	...
	public mProducto() {
		...
		setIconifiable(true);
		setClosable(true);
		setBounds(100, 100, 975, 395);
		getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBackground(UIManager.getColor("Button.background"));
		panel.setBounds(10, 40, 355, 313);
		...
		txtDesc.setBounds(100, 65, 244, 20);
		panel.add(txtDesc);
		
		txtPrecio = new JTextField();
		txtPrecio.setFont(new Font("Verdana", Font.PLAIN, 12));
		txtPrecio.setColumns(10);
		txtPrecio.setBounds(100, 90, 244, 20);
		panel.add(txtPrecio);
		...
		btnAgregar.setBounds(100, 207, 127, 27);
		...
		btnActualizar.setBounds(100, 241, 127, 27);
		...
		btnAceptar.setBounds(214, 31, 130, 27);
		...
		btnCancelar.setBounds(100, 275, 127, 27);
		panel.add(btnCancelar);
		
		JPanel panel_1 = new JPanel();
		panel_1.setLayout(null);
		panel_1.setBackground(new Color(240, 240, 240));
		panel_1.setBounds(380, 40, 569, 313);
		...
		btnBuscar.setBounds(289, 30, 130, 27);
		...
		btnEliminar.setBounds(429, 30, 130, 27);
		...
		btnSalir.setBounds(429, 276, 130, 27);
		...
		btnReporte.setBounds(289, 276, 130, 27);
