...
public class cDias extends JInternalFrame {
	/**
	 * 
	 */
	...
	public cDias() {
		...
		btnBuscar.setIcon(new ImageIcon(cDias.class.getResource("/img/buscar.png")));
		...
		btnBuscar.setBounds(261, 122, 130, 29);
		...
		btnSalir.setIcon(new ImageIcon(cDias.class.getResource("/img/cerrarN.png")));
		...
		btnSalir.setBounds(475, 315, 130, 29);
