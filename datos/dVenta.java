...
public class dVenta {
	...
	// LISTADO POR ID CLIENTE
	public DefaultTableModel BuscarId(String idC) {
		String [] nombresColumnas = {"IdVenta","IdCliente","IdTrabajador","NumeroVenta","FechaVenta","Monto","Estado"};
		String [] registros = new String[7];
		DefaultTableModel modelo = new DefaultTableModel(null,nombresColumnas);
		totalregistros=0;
		String sql ="select * from venta where IdCliente like '%" + idC+ "%'";
		PreparedStatement pst = null;
		ResultSet rs;
		try
        {
        ...
        {            
            JOptionPane.showMessageDialog(null,"Error listar id cliente "+e.getMessage());            
        }		
		return modelo;
	}
	
	// LISTADO POR ID TRABAJADOR
	public DefaultTableModel BuscarIdTrabajador(String idT) {
		String [] nombresColumnas = {"IdVenta","IdCliente","IdTrabajador","NumeroVenta","FechaVenta","Monto","Estado"};
		String [] registros = new String[7];
		DefaultTableModel modelo = new DefaultTableModel(null,nombresColumnas);
		totalregistros=0;
		String sql ="select * from venta where IdTrabajador like '%" + idT+ "%'";
		PreparedStatement pst = null;
		ResultSet rs;
		try
        {
        ...
        {            
            JOptionPane.showMessageDialog(null,"Error listar id trabajador. "+e.getMessage());            
        }
